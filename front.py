...
# Add image file 
bg = PhotoImage(file = "img/bgg.png")
...
img1 = customtkinter.CTkImage(Image.open("img/adm.png"),size=(131,120))
...
img2 = customtkinter.CTkImage(Image.open("img/emp.png"),size=(131,120))
